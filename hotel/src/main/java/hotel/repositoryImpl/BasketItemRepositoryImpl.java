...
public class BasketItemRepositoryImpl implements BasketItemRepository{
	...
	public int countBasketItemPrice(int quantityOfDays, int quantityOfBreakfasts, int priceForOneDay) {
		int priceForOneBreakfast = 17;
		return quantityOfDays * priceForOneDay + quantityOfBreakfasts * priceForOneBreakfast;
	}
}
