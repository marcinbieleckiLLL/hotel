			...
			<section>
				<div class="jumbotron">
					<div class="col-md-6 col-md-offset-5 ">
						<span class="label label-danger" class="btn btn-primary btn-lg"><spring:message code="addAccount.index" />	</span>
					</div>
				</div>
			</section>
				...
				<div class="col-md-6 col-md-offset-3 ">
					<div class="panel panel-info">
						<div class="panel-heading">
									<h3 class="panel-title" style="text-align:center"><spring:message code="addAccount.formularTitle" /></h3>
						</div>
								...
								<fieldset>
									...
									<div-class="form-group" style="text-align:center">
											...
											<label class="control-label col-sm-4  col-sm-offset-1 primary-label" for="pwd">
													...
													<spring:message code="addAccount.username" />
											</label>
									...
									<div-class="form-group" style="text-align:center">
											...
											<label class="control-label col-sm-2  col-sm-offset-3 for="pwd">
													...
													<spring:message code="addAccount.password" />
											</label>
											<div class="col-sm-3">
