...
public class RoomsAndFloorsInsert {
	...
	public List<Room> roomInsert(){
		...
		Room room1 = new Room("pokój drugi","dwuosobowy", 190, "zachód");
		...
		Room room4 = new Room("pokój pi¹ty","czteroosobowy", 400, "po³udnie");
		listOfRoomsOnOneFloor.add(room4);
		Room room5 = new Room("pokój szósty","dwuosobowy", 200, "pó³noc");
		listOfRoomsOnOneFloor.add(room5);
		Room room6 = new Room("pokój siódmy","jednoosobowy", 140, "wschód");
		listOfRoomsOnOneFloor.add(room6);
		Room room7 = new Room("pokój ósmy","trzyosobowy", 260, "po³udnie");
