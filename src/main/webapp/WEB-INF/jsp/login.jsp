			...
			<section>
				<div class="jumbotron">
					<div class="container">
						...
						<h2 style="text-align:center"><spring:message code="login.createAccount" /></h2>
						<h2>${user}</h2>
					</div>
				</div>
			</section>
						...
						<div class="col-md-6 col-md-offset-3 ">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title" style="text-align:center"><spring:message code="login.login" /></h3>
								</div>
							<div class="panel-body">
								...
								<a href="<spring:url value="/addAccount" />" class="btn btn-link">
									<h2><spring:message code="login.lackoOfAccount" /></h2>
								</a>
							</div>
							</div>
						</div>
